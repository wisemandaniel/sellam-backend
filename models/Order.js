...
const userSchema = new mongoose.Schema(
  {
    ...
    // ✅ NEW FIELD: Approval status for riders
...
userSchema.post("save", async function (doc) {
  try {
    // Use mongoose.model to retrieve the Account model – avoids circular dependency issues
...
// Use existing model if it has already been compiled, otherwise create it.
